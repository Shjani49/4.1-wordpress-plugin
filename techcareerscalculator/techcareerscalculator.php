<?php
/*
Plugin Name: TECHCareer Calculator
...
Author: Shivani
Version: 1.0
Author URI: http://ShivaniJani.ca
*/
 ...
 * @ Link: https://github.com/TECHCareers-by-Manpower/4.1-php-advanced/blob/master/calc.php
 */
...
if (isset($_GET['num1']) && !empty($_GET['num1'])) {
    $num1 = (int) $_GET['num1']; // We can type-cast this to a number using (integer) before the value. It does its best to convert to integer in this case.
} else {
